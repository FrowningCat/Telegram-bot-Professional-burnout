...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Admin\Desktop\Работа\Проекты\tg bot Burnout\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Admin\Desktop\Работа\Проекты\tg bot Burnout\venv\Scripts\deactivate.nu'
